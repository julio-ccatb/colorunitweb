...
const Schema: z.ZodType<Prisma.BaseCreateNestedManyWithoutTbaseInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => BaseUncheckedCreateWithoutTbaseInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => BaseCreateOrConnectWithoutTbaseInputObjectSchema),
        z.lazy(() => BaseCreateOrConnectWithoutTbaseInputObjectSchema).array(),
      ])
      .optional(),
    createMany: z
...
export const BaseCreateNestedManyWithoutTbaseInputObjectSchema = Schema;

...
const Schema: z.ZodType<Prisma.RegColBasesCreateNestedManyWithoutBaseInput> = z
  .object({
    create: z
      .union([
...
export const RegColBasesCreateNestedManyWithoutBaseInputObjectSchema = Schema;

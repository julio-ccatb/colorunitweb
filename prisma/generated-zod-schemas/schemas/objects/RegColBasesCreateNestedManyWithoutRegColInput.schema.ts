...
const Schema: z.ZodType<Prisma.RegColBasesCreateNestedManyWithoutRegColInput> =
  z
    .object({
      create: z
        .union([
...
export const RegColBasesCreateNestedManyWithoutRegColInputObjectSchema = Schema;

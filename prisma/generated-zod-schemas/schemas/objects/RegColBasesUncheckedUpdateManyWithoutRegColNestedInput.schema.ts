...
const Schema: z.ZodType<Prisma.RegColBasesUncheckedUpdateManyWithoutRegColNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RegColBasesUncheckedUpdateManyWithoutRegColNestedInputObjectSchema =
  Schema;

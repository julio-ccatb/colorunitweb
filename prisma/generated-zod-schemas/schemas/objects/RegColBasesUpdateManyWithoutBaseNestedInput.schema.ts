...
const Schema: z.ZodType<Prisma.RegColBasesUpdateManyWithoutBaseNestedInput> = z
  .object({
    create: z
      .union([
...
export const RegColBasesUpdateManyWithoutBaseNestedInputObjectSchema = Schema;

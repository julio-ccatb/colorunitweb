...
const Schema: z.ZodType<Prisma.RegColColorantsCreateNestedManyWithoutColorantInput> =
  z
    .object({
      create: z
        .union([
...
export const RegColColorantsCreateNestedManyWithoutColorantInputObjectSchema =
  Schema;

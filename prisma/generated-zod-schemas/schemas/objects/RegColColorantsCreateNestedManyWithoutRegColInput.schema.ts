...
const Schema: z.ZodType<Prisma.RegColColorantsCreateNestedManyWithoutRegColInput> =
  z
    .object({
      create: z
        .union([
...
export const RegColColorantsCreateNestedManyWithoutRegColInputObjectSchema =
  Schema;

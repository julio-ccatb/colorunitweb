...
const Schema: z.ZodType<Prisma.RegColColorantsUncheckedUpdateManyWithoutColorantNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RegColColorantsUncheckedUpdateManyWithoutColorantNestedInputObjectSchema =
  Schema;

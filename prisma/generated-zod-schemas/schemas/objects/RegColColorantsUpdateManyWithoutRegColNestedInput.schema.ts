...
const Schema: z.ZodType<Prisma.RegColColorantsUpdateManyWithoutRegColNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RegColColorantsUpdateManyWithoutRegColNestedInputObjectSchema =
  Schema;

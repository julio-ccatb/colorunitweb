...
import { RegcolcolorantsUpdateManyWithoutColorantNestedInputSchema } from './RegcolcolorantsUpdateManyWithoutColorantNestedInputSchema';

export const ColorantUpdateInputSchema: z.ZodType<Prisma.ColorantUpdateInput> = z.object({
  ...
  regcolcolorants: z.lazy(() => RegcolcolorantsUpdateManyWithoutColorantNestedInputSchema).optional()
}).strict();

export default ColorantUpdateInputSchema;

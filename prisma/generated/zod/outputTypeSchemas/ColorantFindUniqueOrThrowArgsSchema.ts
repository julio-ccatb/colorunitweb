...
export const ColorantFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ColorantFindUniqueOrThrowArgs> = z.object({
  select: ColorantSelectSchema.optional(),
  include: ColorantIncludeSchema.optional(),
  where: ColorantWhereUniqueInputSchema,
}).strict()

export default ColorantFindUniqueOrThrowArgsSchema;

...
export const RegcolUpdateArgsSchema: z.ZodType<Prisma.RegcolUpdateArgs> = z.object({
  select: RegcolSelectSchema.optional(),
  include: RegcolIncludeSchema.optional(),
  data: z.union([ RegcolUpdateInputSchema,RegcolUncheckedUpdateInputSchema ]),
  where: RegcolWhereUniqueInputSchema,
}).strict()

export default RegcolUpdateArgsSchema;

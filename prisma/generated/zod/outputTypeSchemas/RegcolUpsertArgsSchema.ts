...
import { RegcolUpdateInputSchema } from '../inputTypeSchemas/RegcolUpdateInputSchema'
import { RegcolUncheckedUpdateInputSchema } from '../inputTypeSchemas/RegcolUncheckedUpdateInputSchema'
...
export const RegcolUpsertArgsSchema: z.ZodType<Prisma.RegcolUpsertArgs> = z.object({
  select: RegcolSelectSchema.optional(),
  include: RegcolIncludeSchema.optional(),
  where: RegcolWhereUniqueInputSchema,
  create: z.union([ RegcolCreateInputSchema,RegcolUncheckedCreateInputSchema ]),
  update: z.union([ RegcolUpdateInputSchema,RegcolUncheckedUpdateInputSchema ]),
}).strict()

export default RegcolUpsertArgsSchema;

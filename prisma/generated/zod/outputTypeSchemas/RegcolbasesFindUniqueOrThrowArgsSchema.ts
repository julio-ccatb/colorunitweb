...
export const RegcolbasesFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.RegcolbasesFindUniqueOrThrowArgs> = z.object({
  select: RegcolbasesSelectSchema.optional(),
  include: RegcolbasesIncludeSchema.optional(),
  where: RegcolbasesWhereUniqueInputSchema,
}).strict()

export default RegcolbasesFindUniqueOrThrowArgsSchema;

...
export const TbaseUpdateArgsSchema: z.ZodType<Prisma.TbaseUpdateArgs> = z.object({
  select: TbaseSelectSchema.optional(),
  include: TbaseIncludeSchema.optional(),
  data: z.union([ TbaseUpdateInputSchema,TbaseUncheckedUpdateInputSchema ]),
  where: TbaseWhereUniqueInputSchema,
}).strict()

export default TbaseUpdateArgsSchema;

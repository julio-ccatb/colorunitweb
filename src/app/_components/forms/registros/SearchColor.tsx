  ...
  return (
    ...
    >
      <div className="join flex flex-col ">
        <div className="join-item flex flex-col gap-2">
          <div className="join-vertical max-w-sm">
            <div className="join rounded">
              <input
                ...
                placeholder="R"
                className={`join-item w-1/3 border p-2 text-center ${
            ...
            <div className="join  w-full">
              ...
              <button
                ...
                type="submit"
                className=" border-1 flex items-center justify-center gap-2  border border-greenAccent bg-greenAccent px-4 py-2 font-semibold  text-greenLight shadow-md transition-colors duration-200 hover:bg-whitePrimary hover:text-greenAccent"
              >
